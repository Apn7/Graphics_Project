// =============================================================================
// VERTEX-BLEND TEXTURE FRAGMENT SHADER — Phase 7 Phong Upgrade
// =============================================================================
// baseColor = texture × vertex-blended color (blend happened at vertex stage)
// Phong lighting applied on top of the blended result.
// =============================================================================
#version 330 core

in vec2  v_TexCoord;
in vec3  v_BlendedColor;   // Received from vertex shader (interpolated)
in vec3  v_FragPos;
in vec3  v_Normal;
...
void main() {
    ...
    // baseColor: texture modulated by the vertex-stage blend color
    vec3 baseColor = texSample.rgb * v_BlendedColor;
